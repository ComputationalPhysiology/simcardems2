...
from simcardems2.land_CaTrpnsplit import LandModel
...
active_model = LandModel(
    ...
    CaTrpn=prev_missing_mech.u_mechanics[
        0
    ],  # Use prev Catrpn in mech to be consistent with zeta split
    mesh=mesh,
...
j = 0
total_timer = dolfin.Timer("total")
timings_solveloop = []
timings_ep_steps = []
timings_mech_steps = []
no_of_newton_iterations = []
timings_var_transfer = []
for i, ti in enumerate(t):
    ...
    missing_ep_values = mv_ep(ti + config["sim"]["dt"], ode._values, ode.parameters)
