...
active_model = LandModel(
    ...
    s0=s0,
    n0=n0,
    cai=missing_mech.u_mechanics[0],  # In this script mech comes before ep, so previous cai is used
    mesh=mesh,
...
for i, ti in enumerate(t):
    ...
    if i % config["sim"]["N"] == 0:
        ...
        for var_nr in range(config["write_point_mech"]["numbers"]):
            ...
            out_mech_volume_average_timeseries[out_mech_var][i] = (
...
# Plot the results. Currently also output volume averages for selected trace variables
